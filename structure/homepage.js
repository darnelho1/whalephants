...
// about Us Footer effects and links
$('#aboutUsFooter').on('click', function(){
  window.open('../aboutPage/about.html', '_self');
});
...
// vote footer effects and links
$('#voteFooter').on('click', function(){
  window.open('../votePage/vote.html', '_self');
});
...
// count Down Footer effects and links
$('#countDownFooter').on('click', function(){
  window.open('../countDownPage/countDown.html', '_self');
});
...
/// contact Us Footer effects and links
...
// Thanks Footer effects and links
$('#thanksFooter').on('click', function(){
